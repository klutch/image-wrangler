...
const NAME_HINTS := [
    {"word": "lightning", "note": "few-step model: 4-6 steps, CFG 1-2, euler + sgm_uniform, CLIP skip 1",
        "sampler": "euler", "scheduler": "sgm_uniform", "steps": 4, "cfg": 1.0,
        "clip_skip": 1},
    {"word": "hyper", "note": "few-step model: 8 steps, CFG 1-1.5, euler + sgm_uniform, CLIP skip 1",
        "sampler": "euler", "scheduler": "sgm_uniform", "steps": 8, "cfg": 1.0,
        "clip_skip": 1},
    {"word": "turbo", "note": "few-step model: 4-8 steps, CFG 1-2, dpmpp_sde + karras, CLIP skip 1",
        "sampler": "dpmpp_sde", "scheduler": "karras", "steps": 4, "cfg": 1.0,
        "clip_skip": 1},
    {"word": "lcm", "note": "wants its own sampler: lcm + sgm_uniform, 4-8 steps, CFG 1-2, CLIP skip 1",
        "sampler": "lcm", "scheduler": "sgm_uniform", "steps": 4, "cfg": 1.0,
        "clip_skip": 1},
    {"word": "schnell", "note": "few-step model: 4 steps, CFG 1, euler + simple, CLIP skip 1",
        "sampler": "euler", "scheduler": "simple", "steps": 4, "cfg": 1.0,
        "clip_skip": 1},
    {"word": "flux", "note": "20 steps, CFG 1, euler + simple, CLIP skip 1",
    ...
    {"word": "illustrious", "note": "SDXL family: 25 steps, CFG 5-7, euler_ancestral + normal, CLIP skip 2",
        ...
        "clip_skip": 2},
    {"word": "noob", "note": "NoobAI, Illustrious family: 25 steps, CFG 5-7, euler_ancestral + normal, CLIP skip 2",
        "sampler": "euler_ancestral", "scheduler": "normal", "steps": 25, "cfg": 5.0,
        "clip_skip": 2},
    {"word": "anime", "note": "anime models are usually Illustrious or Pony family: 25 steps, CFG 5-7, euler_ancestral + normal, CLIP skip 2",
        "sampler": "euler_ancestral", "scheduler": "normal", "steps": 25, "cfg": 5.0,
        "clip_skip": 2},
    {"word": "xl", "note": "SDXL family: 20-30 steps, CFG 5-7, dpmpp_2m + karras, CLIP skip 1",
